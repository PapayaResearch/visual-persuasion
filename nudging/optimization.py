...
class BaseCompetition(ABC):
    """
    Base class for competition strategies.
    ...
    min_rounds_before_equilibrium: int = 10
    max_rounds_per_pair: int = 10
    ...
    @abstractmethod
    def _conduct_contest(self, image_a_bytes: bytes, image_b_bytes: bytes,
                        image_a_name: str, image_b_name: str, **kwargs):
...
@dataclasses.dataclass
class ScoreBasedCompetition(BaseCompetition):
    """
    Score-based competition using individual image scoring.
    """
    judge_prompt: str = ""
...
class OptimizationPipeline:
    ...
    # Competition type: 'choice' or 'score'
    competition_type: str = 'choice'
